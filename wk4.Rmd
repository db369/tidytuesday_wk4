...
top_25$occupation <- str_replace(top_25$occupation, "\x96", "/")
...
top_25 %>%
  ...
  ggplot(aes(x=fct_reorder(occupation, Female), y = Female, col = occupation)) +
    ...
    annotate("text", x=3, y=550000, label = "Female") +  
    annotate("text", x=2, y=541000, label = "Male") +
    annotate("point", x=3, y=520000) +
    annotate("point", x=3, y=520000, size=1, col="white") +
    annotate("point", x=2, y=520000) 
...
t15 <- top_15 %>%
  ggplot(aes(x=fct_reorder(occupation, diff), y = Female, col = occupation)) +
    ...
    scale_color_manual(values = pal) +
    annotate("text", x=3, y=550000, label = "Female") +  
    annotate("text", x=2, y=540000, label = "Male") +
...
b15 <- bottom_15 %>%
  ggplot(aes(x=fct_reorder(occupation, diff), y = Female, col = occupation)) +
    ...
    scale_y_continuous(labels = comma) + 
    scale_color_manual(values = pal) +
    annotate("text", x=2, y=225000, label = "Female") +  
    annotate("text", x=1, y=220000, label = "Male") +
    annotate("point", x=2, y=200000) +
    annotate("point", x=2, y=200000, size=1, col="white") +
    annotate("point", x=1, y=200000) 
